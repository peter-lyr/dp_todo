...
function M._map()
  require 'which-key'.register {
    ...
    ['<leader>t'] = { name = 'todo', },
    ['<leader>t<leader>'] = { name = 'todo.telescope', },
    ...
    ['<leader>t<leader><leader>'] = { name = 'todo.telescope.done', },
    ...
    ['<leader>tq<leader>'] = { name = 'todo.quickfix.done', },
